  ...
  <ol class="bibliography">
    ...
    <li>
      <div class="pub-row">
        ...
        <div class="col-sm-9" style="padding: 0 15px;">
          <div class="title"><a href="{{ link.pdf }}">{{ link.title }}</a></div>
          <div class="author">{{ link.authors }}</div>
          <div class="periodical"><em>{{ link.conference }}</em></div>
          <div class="links">
            {% if link.abstract %}
            <button class="btn btn-sm z-depth-0" style="font-size: 12px; margin: 0; padding: 2px 5px;" onclick="toggleAbstract(this)">[+] Abstract</button>
